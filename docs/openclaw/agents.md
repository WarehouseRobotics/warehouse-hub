...
```bash
wrobohub-openclaw-cli agent --agent $HUB_ACCOUNTING_AGENT --message "Let the user know most recent EUR/USD exchange rate and how it changed in the past week (just a summary) and reply in DM via Slack" --deliver
```
