...
sudo cp "$REPO_DIR/openclaw/system-image/userhome/.config/systemd/user/openclaw-control-api.service" $HOME/.config/systemd/user/openclaw-control-api.service
